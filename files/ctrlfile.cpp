...
bool ctrlfile::CreateDefaultIniFile()
{
    ...
    SetValue("XBEE_ALARMOUT1",   "payload1","0x443405");
    SetValue("XBEE_ALARMOUT1",   "payload2","0x443404");
    ...
    SetValue("XBEE_ALARMOUT2",   "payload1","0x0100010010");
    SetValue("XBEE_ALARMOUT2",   "payload2","0x0100000010");
    SetValue("XBEE_ALARMIN1",    "name",    "nc");
    SetValue("XBEE_ALARMIN1",    "addr64",  "0x00000000000000000");
    ...
    SetValue("XBEE_ALARMIN1",    "payload1","0x443103");
    SetValue("XBEE_ALARMIN1",    "payload2","0x443103");
    SetValue("XBEE_ALARMIN2",    "name",    "nc");
    SetValue("XBEE_ALARMIN2",    "addr64",  "0x0000000000000000");
    ...
    SetValue("XBEE_ALARMIN2",    "payload1","0x443103");
    SetValue("XBEE_ALARMIN2",    "payload2","0x443103");
    ...
    SetValue("XBEE_TIMESWITCH1", "payload1","0x0100010010");
    SetValue("XBEE_TIMESWITCH1", "payload2","0x0100000010");
    ...
    SetValue("XBEE_TIMESWITCH2", "payload1","0x0100010010");
    SetValue("XBEE_TIMESWITCH2", "payload2","0x0100000010");
    SetValue("XBEE_ONOFF1",      "name",    "nc");
    SetValue("XBEE_ONOFF1",      "addr64",  "0x00000000000000000");
    ...
    SetValue("XBEE_ONOFF1",      "payload1","0x443103");
    SetValue("XBEE_ONOFF1",      "payload2","0x443103");
    SetValue("XBEE_ONOFF2",      "name",    "nc");
    SetValue("XBEE_ONOFF2",      "addr64",  "0x00000000000000000");
    ...
    SetValue("XBEE_ONOFF2",      "payload1","0x443103");
    SetValue("XBEE_ONOFF2",      "payload2","0x443103");
    return true;
}
